...
import 'package:haerangga/widget/dOrganizationTile.dart';

class DispatchExplain extends StatefulWidget {
  ...
  @override
  _DispatchExplainState createState() => _DispatchExplainState();
}

class _DispatchExplainState extends State<DispatchExplain> {
  List<String> city = [];
  ...
  Widget d_organization_list() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return DOrganizationTile(name[index], city[index], location[index],
